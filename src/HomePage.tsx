    ...
    <div>
      ...
      <div className="fixed w-full -z-10 h-screen overflow-x-hidden">
        ...
        <div
          ...
          id="home"
        >
          <div className="bg-clip-text text-transparent bg-gradient-to-tr from-purple-600  to-fuchsia-600 font-[Montesrrat] leading-none md:text-[3rem] text-center font-bold text-[2.5rem]  lg:text-[6rem] ">
            We Are The
            ...
            <p className="text-white lg:text-[1.5rem] text-[1rem] p-3 mt-8 text-center ">
              Rebuilding how India learns-Beyond Borders, Beyond Syllabus,
              Beyond Gatekeepers, Beyond Paywalls
            </p>
            <div className="font-thin text-[10px]">
              <JoinUsButton
                onClick={onJoinUs}
                className="my-14 items-center sm:my-20"
              />
            </div>
          </div>
